<template>
  <div class="app-container">
      ...
      <el-col :span="18" style="text-align: right">
        <el-form :inline="true" :model="searchForm">
          ...
          <el-form-item label="登录名:">
            <el-input v-model="searchForm.username" placeholder="登录名" clearable />
          </el-form-item>
    ...
    <el-table
      ...
      :data="pageData"
    >
      <el-table-column prop="username" align="center" label="登录名" show-overflow-tooltip show-tooltip-when-overflow />
...
<script>
import { userDelete, userPageSearch } from '../../../api/user'
...
export default {
  ...
  methods: {
    ...
    flushPage(pageIndex) {
      ...
      userPageSearch(queryParams).then(res => {
